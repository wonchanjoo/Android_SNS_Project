...
import com.example.sns_project.Post
import com.example.sns_project.WatchPostingAdapter
import com.example.sns_project_watch.databinding.ActivityFeedBinding
...
class FeedActivity : AppCompatActivity() {
    ...
    private var adapter: WatchPostingAdapter? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.watchPostRecyclerView.setHasFixedSize(true)
        binding.watchPostRecyclerView.layoutManager = LinearLayoutManager(this)
        adapter = WatchPostingAdapter(this, emptyList())
        binding.watchPostRecyclerView.adapter = adapter
